    ...
    return (
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
            <section className="rounded-[28px] bg-[#0f2347] px-6 py-7 text-white shadow-[0_24px_60px_rgba(15,35,71,0.24)]">
                <h1 className="mt-2 text-4xl font-black tracking-tight">Alertas y prioridades</h1>
                <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-200">
                    Destinos reales, prioridad general y horarios de silencio bajo un mismo criterio operativo.
                </p>
            </section>
                ...
                <div className="space-y-8">
                    ...
                    <div className="border-t border-slate-100 pt-8">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-3xl font-black tracking-tight text-slate-900">Prioridad general</h2>
                        </div>
                    ...
                    <div className="border-t border-slate-100 pt-8">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-3xl font-black tracking-tight text-slate-900">Prioridad minima</h2>
                        </div>
                    ...
                    <div className="border-t border-slate-100 pt-8">
                        ...
                        <div className="mt-5 flex flex-wrap gap-3">
                            {Object.entries(categories).map(([key, value]) => (
                                ...
                                >
                                    {key === "salud" ? "Estado de cuenta" : key.charAt(0).toUpperCase() + key.slice(1)}
                                </button>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="grid gap-8 border-t border-slate-100 pt-8 md:grid-cols-2">
                        <div>
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-3xl font-black tracking-tight text-slate-900">Horario de silencio</h2>
                            </div>
