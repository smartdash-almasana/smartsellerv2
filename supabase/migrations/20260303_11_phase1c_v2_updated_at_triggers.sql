-- ─────────────────────────────────────────────────────────────────────────────
-- Phase 1.C — Triggers updated_at en todas las tablas public sin trigger
-- Migration: 20260303_11_phase1c_v2_updated_at_triggers.sql
--
-- INVENTARIO PREVIO (tablas con updated_at, sin trigger BEFORE UPDATE):
...
--
-- Función reutilizada: public.set_updated_at() (ya existía, devuelve trigger)
-- Nomenclatura: trg_<table>_set_updated_at (idempotente via DROP IF EXISTS)
-- ─────────────────────────────────────────────────────────────────────────────
